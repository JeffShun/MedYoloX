...
class kidney_detection_cfg:
    ...
    log_dir = work_dir + "/Logs/kidney/ResNet3D"
    checkpoints_dir = work_dir + '/checkpoints/kidney/ResNet3D'
    load_from = work_dir + '/checkpoints/kidney/ResNet3D/20.pth'
